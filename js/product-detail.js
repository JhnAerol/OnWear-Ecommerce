...
document.addEventListener("DOMContentLoaded", () => {
  ...
  <div class="row g-0">
    <div class="col-md-4 d-flex align-items-center justify-content-center">
      <img id="mainImage" src="${item.images[0]}" class="img-fluid rounded-start" width="400" height="400" alt="${item.name}">
    </div>
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <button class="btn btn-primary mt-2 mb-3" id="addToCartBtn">ADD TO CART</button>

        <div id="thumbContainer" class="d-flex gap-2 flex-wrap mt-3"></div>
      </div>
    </div>
  </div>
`;
...
thumbContainer.innerHTML = item.images.map((img, i) => `
  <img src="${img}" class="product-thumb ${i === 0 ? 'active' : ''} card" style="width:80px;height:80px;object-fit:cover;border-radius:8px;cursor:pointer;border:2px solid transparent;">
`).join("");
